          ...
          {!user && (
            <div className="space-y-2 pt-2 border-t border-border">
              {lineLoginEnabled && <button
                ...
                className="flex items-center gap-2 w-full px-3 py-2.5 rounded-lg bg-[#06C755] text-white text-sm font-medium"
              >
              ...
              <button
                onClick={() => { toast("Google 登入功能即將開放"); setMobileOpen(false); }}
                className="flex items-center gap-2 w-full px-3 py-2.5 rounded-lg bg-white text-gray-700 border border-gray-300 text-sm font-medium"
              >
